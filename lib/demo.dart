...
class _SearchExampleState extends State<SearchExample> {
  ...
  void _onSearchChanged() {
    String query = searchController.text.toLowerCase(); // Get the input in lowercase.

    // Update displayedItems by filtering items that contain the search term in the 'cardname'.
    setState(() {
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  title: Text(
                    displayedItems[index]['cardname'], // Display the 'cardname' field
                    style: GoogleFonts.lato(), // Use Google Fonts here
                  ),
                  subtitle: Text(
                    displayedItems[index]['description'], // Display the 'description' field
                  ),
                );
              },
            ),
